...
static const int vertpadtab         = 6;
static const int horizpadtabi       = 6;
...
static const char* eww[] = { "rofi", "-show", "drun", "-theme", ".config/chadwm-boki/rofi-christitustech/config.rasi", NULL };
static const char* firefox[] = { "firefox", NULL };
static const char* thunar[] = { "thunar", NULL };
static const char* kitty[] = { "kitty", NULL };
static const char* sublime[] = { "subl", NULL };
static const char* power[] = { "bash", "-c","~/.config/chadwm-boki/powermenu/powermenu.sh", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_d,       spawn,          SHCMD("~/.config/chadwm-boki/launcher-arco/launcher.sh") },
    { MODKEY,                           XK_Return,  spawn,          SHCMD("ghostty")},
    { MODKEY,                           XK_e,  spawn,               SHCMD("subl")},
